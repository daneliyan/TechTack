...
/* harmony import */ var _components_video_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_components_video_js__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _components_reviews_view_all_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/reviews_view-all.js */ "./src/js/components/reviews_view-all.js");
/* harmony import */ var _components_reviews_view_all_js__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_components_reviews_view_all_js__WEBPACK_IMPORTED_MODULE_1__);
...
/***/ "./src/js/components/reviews_view-all.js":
/*!***********************************************!*\
  !*** ./src/js/components/reviews_view-all.js ***!
  \***********************************************/
/***/ (() => {

const viewAll = document.querySelector('.btn-view__all');
const cardsLength = document.querySelectorAll('.reviews__item').length;
let items = 3;
...
const play = document.querySelector('.why-us__play');
const video = document.querySelector('.why-us__video video');
play.addEventListener('click', () => {
  video.play();
  video.setAttribute('controls', 'controls');
  play.classList.add('why-us__play--hidden');
});
